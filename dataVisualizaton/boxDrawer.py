    ...
    for index, row in csv_data.iterrows():
        try:
            ...
            if class_id not in class_map:
                print(
                    f"Warning: Class ID {class_id} not defined in class_map. Skipping."
                )
                continue
            ...
            cv2.putText(
                ...
                (
                    x_min + 5,
                    y_min - 5,
                ),  # Position text slightly inside the background box
...
if __name__ == "__main__":
    IMAGE_PATH = "/home/kaloyan/Code/Thesis/SeedGan/data/rolling images/output/images/stitched_0002.jpg"
    CSV_PATH = "/home/kaloyan/Code/Thesis/SeedGan/data/rolling images/output/labels/stitched_0002.txt"
